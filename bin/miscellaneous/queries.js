...
const nameTerminalNodeQuery = nodeQuery(Query.fromExpression("//name/@*")),
      ...
      termNameNodesQuery = nodesQuery(Query.fromExpression("/term/name")),
      ...
      expressionTermNodesQuery = nodesQuery(Query.fromExpression("/expression/term")),
