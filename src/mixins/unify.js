...
export function unifyWithCombinators(statement, assignments, stated, localContext) {
...
export function unifyWithBracketedCombinator(statement, assignments, stated, localContext) {
