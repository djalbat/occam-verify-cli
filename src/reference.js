  ...
  verify(localContext) {
    ...
    if (!verified) {
      const reference = this, ///
            metaLemmaPresent = localContext.isMetaLemmaPresentByReference(reference, localContext),
            metatheoremPresent = localContext.isMetatheoremPresentByReference(reference, localContext);
