    ...
    _createClass(MetaSubstitution, [
        ...
        },
        {
            ...
            value: function matchNodes(nodes) {
                ...
                if (!matches) {
                    var childNodes = nodes, bracketedMetastatementChildNodeMatches = (0, _metaAssertion.matchBracketedMetastatementChildNode)(childNodes, function(bracketedMetastatementChildNode) {
    ...
    ], [
        {
            ...
            value: function fromMetavariableNameAndNodes(metavariableName, nodes) {
                var bracketedMetastatementChildNode = (0, _metaAssertion.bracketedMetastatementChildNodeFromChildNodes)(nodes);
